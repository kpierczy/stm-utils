 ...
 * @modified   Friday, 16th July 2021 2:18:09 pm
 * @project    stm-utils
 * @brief      HAL configuration header for STM32L0xx devices
 *    
 * @copyright Krzysztof Pierczyk © 2022
 * /// ============================================================================================================================ */

#ifndef __STM_UTILS_HAL_CONFIG_STM32L0xx_H__
#define __STM_UTILS_HAL_CONFIG_STM32L0xx_H__
