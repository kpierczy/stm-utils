...
# @modified   Friday, 28th October 2022 11:01:42 pm
# @project    stm-utils
...
for family in arguments.families:
    ...
    try:
        ...
        utils.os.refresh_directory(f'{PACKAGE_HOME}/include/hal/{DEVICE_NAME}/Legacy')
    ...
    # On failure
        ...
        utils.logger.error(f'Failed to update HAL library for {family.capitalize()} family ({ex})')
